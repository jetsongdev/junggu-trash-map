...
### Added
- 현재 보고 있는 자치구의 외곽선을 지도에 amber 점선으로 띄웁니다. 셀렉터 패널을 닫아 둔 상태에서도 어느 구를 보고 있는지 한눈에 보이고, 패닝으로 다른 구에 진입하면 외곽선이 따라 옮겨갑니다. 색은 셀렉터 그리드의 "현재 보는 구" 강조와 같은 톤이라 두 표시가 한 의미로 묶입니다 (P3.4).
